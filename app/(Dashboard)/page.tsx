    ...
    <div className='min-h-screen w-full bg-white'>
      ...
      <div className='w-full flex-1 relative hidden lg:block'>
        ...
        <input
         ...
         className='w-full border rounded-sm pl-10 border-gray-300 py-2 max-w-[500] text-gray-400' placeholder='Search'
        />
      ...
      <div className='flex-1 w-full lg:hidden '>
        ...
        <Button  variant={"outline"} className='text-gray-400 w-[100px] tracking-wider' >
